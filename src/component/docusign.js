...
const oAuthClientID = "bc749f20-92d4-4cc5-b5ac-7ea77487d50c"; // aasu
...
// "http://localhost:3000/jsfiddleImplicitGrantReturn.html";
// "http://localhost:3000/oauth-response/";
...
class UserInfo {
    ...
    async getUserInfo() {
        ...
        try {
            userInfoResponse = await getAccountInfo();
        } catch (e) {
            this.errMsg =
        ...
        ({
            ...
            accountIsDefault: a.accountIsDefault,
            accountBaseUrl: a.accountBaseUrl + this.eSignBase,
            corsError: false
        }))
